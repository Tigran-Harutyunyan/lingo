...
export type UnitWithLessons = typeof units.$inferInsert & { lessons: Lesson & { completed: boolean }[] };
export type UserProgress = Required<typeof userProgress.$inferInsert> & {
  activeCourse: Course
  activeCourseId: number
};

export type Unit = Required<typeof units.$inferInsert>
export type ChallengeProgress = typeof challengeProgress.$inferInsert;
export type ChallengeOptions = typeof challengeOptions.$inferInsert;
export type Subscription = typeof userSubscription.$inferInsert & { isActive?: boolean };
export type courseProgress = {
  activeLesson: Lesson,
  activeLessonId: number
};

export type LessonWithExtras = Lesson & {
